...
let counter = 0;
function createData(name, mzda, fat) {
  counter += 1;
  return { id: counter, name, mzda, fat};
}
...
const rows = [
  ...
  { id: 'mzda', numeric: true, disablePadding: false, label: 'Mzda' },
...
class EnhancedTable extends React.Component {
  ...
  componentWillMount() {
    ...
    post_data.forEach(post => {
      console.log(post);
      state_data.push(createData(post.node.frontmatter.position, post.node.frontmatter.mzda, post.node.frontmatter.space))
    });
                    ...
                    .map(n => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell className="position" align="right">{n.mzda}</TableCell>
