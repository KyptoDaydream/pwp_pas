          ...
          <Grid container spacing={24}>
            ...
            <Grid item xs={8} className="responsive_grid_2">
              <div className="title_wrapper">
                ...
                <Divider height="70px" />
                <p className="text_title">Personálna agentúra </p>
                <ul>
                  <li>
                ...
                <Divider height="25px" />
                <ButtonWrapper
                  buttonText="Personálna agentúra"
                ...
                />
                <Divider height="40px" />
                <p className="text_title">Upratovací servis </p>
                <ul>
